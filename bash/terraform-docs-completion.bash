...
__terraform-docs_handle_go_custom_completion()
{
    ...
    # Calling ${words[0]} instead of directly terraform-docs allows handling aliases
    args=("${words[@]:1}")
    # Disable ActiveHelp which is not supported for bash completion v1
    requestComp="TERRAFORM_DOCS_ACTIVE_HELP=0 ${words[0]} __completeNoDesc ${args[*]}"
...
_terraform-docs_completion_fish()
{
    last_command="terraform-docs_completion_fish"
